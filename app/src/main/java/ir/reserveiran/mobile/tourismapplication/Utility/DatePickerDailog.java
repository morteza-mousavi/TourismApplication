...
import ir.reserveiran.mobile.tourismapplication.wheel.ArrayWheelAdapter;
import ir.reserveiran.mobile.tourismapplication.wheel.OnWheelChangedListener;
import ir.reserveiran.mobile.tourismapplication.wheel.WheelView;
	 ...
	 requestWindowFeature(Window.FEATURE_NO_TITLE);
		...
		btnset.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				dtp.OnDoneButton(DatePickerDailog.this,day_array[day.getCurrentItem()] +"/"+ months[month.getCurrentItem()] +"/"+ year_array[year.getCurrentItem()]);
