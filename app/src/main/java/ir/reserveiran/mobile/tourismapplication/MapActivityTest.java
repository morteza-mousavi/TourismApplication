...
public class MapActivityTest extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap map) {
     ...
     //  broadcastReceiver.getResultExtras(lat);


    // Toast.makeText(getApplicationContext(), "lat,lang :" , Toast.LENGTH_LONG).show();



        MarkerOptions markerOptions = new MarkerOptions()
                .position(new LatLng(51.675456, 21.9876567))
                .title("Me")
                .snippet("Me")
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder()
                .zoom(12)
                .target(new LatLng(51.675456, 21.9876567)).build();
